...
Introduction
This project implements a fully automated square jigsaw puzzle solver inspired by the paper “A Fully Automated Greedy Square Jigsaw Puzzle Solver” by Pomeranz et al. (CVPR 2011).
...
Evaluation Method
Since the original images are available, evaluation can be performed using pixel-based metrics such as Mean Squared Error (MSE).
